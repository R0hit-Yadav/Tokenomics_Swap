module dxlyn::dxlyn_swap_test {
    ...
    public fun test_swap_fa_to_dxlyn_and_back(admin: &signer, user: &signer) {
        // 1. Setup: Initialize coins and swap module
